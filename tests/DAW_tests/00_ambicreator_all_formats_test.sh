...
# Script: 00_ambicreator_all_formats_reaper_test.sh
...
PROJECT_PATH="Reaper/00_ambicreator_all_formats.rpp"        					# Path to REAPER project file
OUTPUT_PATH="Results/00_ambicreator_all_formats_reaper.wav"  					# Path where REAPER will save rendered output
REFERENCE_PATH="Reference/00_ambicreator_all_formats_reaper_reference.wav"   	# Path to reference audio file
LOG_FILE="Reference/00_ambicreator_all_formats_reaper_results.txt"           	# Log file for REAPER output
TIMEOUT=300                                                 					# Maximum time (seconds) to wait for render
SOX_DIFF_OUTPUT="Results/00_ambicreator_all_formats_reaper_test_diff_output.wav"     # Output file for audio difference
