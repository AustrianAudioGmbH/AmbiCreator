...
public:
    ...
    TitleBar (Tin inputWidget,
        ...
        inputWidget (std::move (inputWidget)),
        outputWidget (std::move (outputWidget)),
        titlePath (std::move (titlePath)),
        useTitlePath (useTitlePath),
        centreX (centreX),
        centreY (centreY),
        centreSetExternally (centreSetExternally)
    {
    }
    ~TitleBar() override {}
    ...
    void paint (juce::Graphics& g) override
    {
        ...
        if (alert)
            g.drawFittedText (shortAlertMessage,
                              (int) (inWidgetRightBound + 2.0f),
                              (int) (0.3f * currentHeight),
                              (int) alertTextWidth,
                              (int) (alertTextHeight * 2.0f),
                              Justification::centredLeft,
                              2);
